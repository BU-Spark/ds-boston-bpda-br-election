...
preprocess_features(df2010,name_code=True).to_csv('./election data/2010_Election_processed.csv')
preprocess_features(df2014,name_code=True).to_csv('./election data/2014_Election_processed.csv')
preprocess_features(df2018,name_code=True).to_csv('./election data/2018_Election_processed.csv')